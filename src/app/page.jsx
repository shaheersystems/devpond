      ...
      <div className="max-w-4xl px-2 mx-auto min-h-[100vh] text-center flex flex-col items-center justify-center">
        <div className="p-4 space-y-8">
          ...
          {!added ? (
            <div>
              <form
                className="flex flex-wrap items-center justify-center max-w-lg gap-4 mx-auto md:flex-nowrap"
              ...
              >
                ...
                <Button
                  disabled={loading}
                  type="submit"
                  className="w-full group md:w-auto"
                >
                  {!loading ? (
            ...
            <div className="px-4">
              <p className="flex items-center justify-center gap-2 p-2 font-semibold rounded-md text-neutral-700">
                <span>
                  <CheckCircleIcon className="w-5 h-5 text-accent" />
                </span>
                You've been added to the waitlist. We'll reach out to you soon!
              </p>
            </div>
          )}
        </div>
